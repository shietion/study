...
public class JobCrawler {
	...
	for (int i = 1; i <= 10; i++) {
	    String url = "http://www.lagou.com/jobs/positionAjax.json?gj=3-5%E5%B9%B4&px=default&city=%E6%AD%A6%E6%B1%89&kd=java&pageNo=" + i;
	    driver.get(url);
	...
	for (int i = 0; i < data.size(); i++) {
	    ...
	    System.out.println(position_name + "\t" + com_name + "\t" + r_salary + "\t" + p_education + "\t" + p_createtime + "\t" + post_detail);

	    String sql = " insert into position_tab_tmp (position_source,position_id,position_name,need_year,r_salary,p_createtime," + "com_name,p_education,post_detail) values ('"
		    + position_source + "','" + position_id + "','" + position_name + "','" + need_year + "'," + "'" + r_salary + "','" + p_createtime + "','" + com_name + "','"
		    + p_education + "','" + post_detail + "')";
